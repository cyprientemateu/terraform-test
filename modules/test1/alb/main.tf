...
variable "subnets" {
  default = ["subnet-02e286c9bdfb33f0b", "subnet-011cf4a50c2518de6", "subnet-06024f887faf3709b"]
}
...
resource "aws_lb_listener_rule" "sonarqube" {
  ...
  condition {
    host_header {
      values = ["sonarqube.tccdevops.com"]
    }
  }
